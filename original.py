...
#exporting files
    #inspection
df1.to_csv("inspection_s1_original.csv")
df2.to_csv("inspection_s2_original.csv")
df3.to_csv("inspection_s3_original.csv")
df4.to_csv("inspection_s4_original.csv")
df5.to_csv("inspection_s5_original.csv")
    #repair
rep1.to_csv("repair_s1_original.csv")
rep2.to_csv("repair_s2_original.csv")
rep3.to_csv("repair_s3_original.csv")
rep4.to_csv("repair_s4_original.csv")
rep5.to_csv("repair_s5_original.csv")
    #matrix
matrix.to_csv("matrix_original.csv")
