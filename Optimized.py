...
#exporting files
    #inspection
df1.to_csv("inspection_s1_optimized.csv")
df2.to_csv("inspection_s2_optimized.csv")
df3.to_csv("inspection_s3_optimized.csv")
df4.to_csv("inspection_s4_optimized.csv")
df5.to_csv("inspection_s5_optimized.csv")
    #repair
rep1.to_csv("repair_s1_optimized.csv")
rep2.to_csv("repair_s2_optimized.csv")
rep3.to_csv("repair_s3_optimized.csv")
rep4.to_csv("repair_s4_optimized.csv")
rep5.to_csv("repair_s5_optimized.csv")
    #matrix
matrix.to_csv("matrix_optimized.csv")
